  ...
  <main-layout>
    <div class="content">
      ...
      <div class="section-content">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              downloaded by You on any electronic device, named Sound Realms.
            </p>
          </li>
          <li>
            <p>
        ...
        <h2>Contact Us</h2>
        <p>If you have any questions about this Privacy Policy, don't hestitate to contact us at:</p>
        <p><a href="mailto:dm@varghand.com">dm@varghand.com</a></p>


        <!-- <h2>What information does the Application obtain and how is it used?</h2>
        <p>
          Varghand Publishing AB takes privacy concerns VERY seriously! Right now we don't collect
          any data at all about you except anonymous usage statistics with the purpose of improving
          the user experience of future app versions. This type of data includes the type of mobile
          device you use, your mobile devices unique device ID, the IP address of your mobile
          device, your mobile operating system, the type of mobile Internet browsers you use, and
          information about the way you use the Application. We will never gather any sensitive
        ...
        <p>
          ...
          reasonable time thereafter. We will retain Automatically Collected information for up to
          24 months and thereafter may store it in aggregate. If you’d like us to delete User
          Provided Data that you have provided via the Application, please contact us at
          app@sound-realms.com and we will respond in a reasonable time. Please note that some or
